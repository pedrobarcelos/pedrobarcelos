...
- 👯 I’m looking to collaborate on **Data Sciente**
...
- ⚡ 2023 main goal: **To become a Python Developer!**

### Spotify Playing 🎧
[![Spotify](https://novatorem-dusky-kappa.vercel.app/api/spotify)](https://open.spotify.com/user/pbarcelos56)

<h3 align="left">My main projects:</h3>
<p align="left">
- Projeto (Pyhton) de mineração de dados a fim de descobrir as linguagens de programação mais populares no github: https://github.com/pedrobarcelos/linguagens-mais-usadas
<p align="left">
- Projeto (Java) que exemplifica a criação de um sistema de agendamento de consultas. API completa, MVC, com banco de dados hospedado (desligado no momento): https://github.com/pedrobarcelos/ViverBem
<p align="left">
- Projeto (Java) que é um protótipo de um sistema gerenciador de estoques. API completa, MVC, com banco de dados hospedado (desligado no momento): https://github.com/pedrobarcelos/Stok
<p align="left">
